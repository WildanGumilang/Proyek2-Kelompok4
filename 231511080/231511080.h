...
bool pendaftaranPeriksa(const string& nik, const string& namalengkap, const string& tanggallahir, tAddr awalT, kAddr awalK, kAddr awalKinv); //fungsi untuk mengisi pendaftaran pemeriksaan
...
// void cetakListUserDaftar(dfAddr awal);